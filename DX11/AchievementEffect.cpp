...
void CAchievementEffect::Init()
{
}
void CAchievementEffect::Init(float offset_x, float offset_y, float size_x, float size_y)
{
	VERTEX_3D vertex[4];
...
void CAchievementEffect::Uninit()
{
...
void CAchievementEffect::SetFile(const WCHAR* filename)
{
	if (m_Texture)
	{
		m_Texture->Release();
...
void CAchievementEffect::Update()
{
	if (m_Cnt <= 30)
	{
		m_PY -= 2;
